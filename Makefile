...
mcp-desktop: ## Claude-Desktop-Konfiguration zum Kopieren ausgeben
	...
	@echo ""
	@echo "  Zwei Dinge müssen auf DIESEM Rechner stimmen, sonst schlägt es fehl:"
	@echo ""
	@echo "    a) Der Port darf nicht auf localhost festgenagelt sein."
	@echo "       In docker-compose.yml:  \"$(or $(LAN_IP),0.0.0.0):$(PORT):3000\""
	@echo "       (aktuell: 127.0.0.1 — von außen nicht erreichbar)"
	@echo ""
	@echo "    b) In .env muss die Adresse als erlaubter Host stehen:"
	@echo "       CHEFMIND_ALLOWED_HOSTS=localhost,127.0.0.1,$(or $(LAN_IP),DEINE-SERVER-IP)"
	@echo "       CHEFMIND_ALLOWED_ORIGINS=localhost,127.0.0.1,$(or $(LAN_IP),DEINE-SERVER-IP)"
	@echo ""
